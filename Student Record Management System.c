...
int main()
{
    ...
    printf("____ || Student Record Management System ||____ \n");
     printf("____ | Created By: Musharaf Ali|____");
    gotoxy(19,15);
...
void view()
{
    ...
    system("cls");
    gotoxy(10,3);
    printf("_____| VIEW RECORD |_____");
    gotoxy(10,5);
...
void search()
{
    ...
    system("cls");
    gotoxy(10,3);
    printf("_____| SEARCH RECORD |_____");
    gotoxy(10,5);
...
void modify()
{
    ...
    system("cls");
    gotoxy(10,3);
    printf("_____| MODIFY RECORD |_____");
    gotoxy(10,5);
...
void deleterec()
{
    ...
    system("cls");
    gotoxy(10,3);
    printf("____| DELETE RECORD |_____");
    gotoxy(10,5);
